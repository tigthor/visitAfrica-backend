...
import { validateProfilePage, validateUserRoleBody, validateUserBody } from '../validations/user.validation';
...
router.post('/user/:userId', protectRoute, validateUserBody, verifySuperAdmin, verifyUser, verifyLineManager.checkIfLineManagerExist, UserController.assignUserToManager);
